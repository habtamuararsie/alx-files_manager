...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/Alienz11/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'A file management API built with Node.js by ',
      '<a href="https://github.com/Alienz11">Alienzzz</a>. ',
      'Let us know if there are things we can do to better suit your satisfaction.',
      'Have Fun !!',	
      '</div>',
    ].join('');
